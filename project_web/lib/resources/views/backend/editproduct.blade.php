					...
					<form method="post" enctype="multipart/form-data">
						<div class="row" style="margin-bottom:40px">
							<div class="col-xs-8">
								...
								{
									filebrowserBrowseUrl : '../../editor/ckeditor/ckfinder/ckfinder.html',
									filebrowserImageBrowseUrl : '../../editor/ckeditor/ckfinder/ckfinder.html?type=Images',
									filebrowserFlashBrowseUrl : '../../editor/ckeditor/ckfinder/ckfinder.html?type=Flash',
									filebrowserUploadUrl : '../../editor/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
									filebrowserImageUploadUrl : '../../editor/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
									filebrowserFlashUploadUrl : '../../editor/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
								});
								</script>
								</div>
								<div class="form-group" >
								...
								<div class="form-group" >
									...
									Có: <input type="radio" name="featured" value="1" @if($product->prod_featured==0) checked @endif>
									Không: <input type="radio" name="featured" value="0" @if($product->prod_featured==1) checked @endif>
								</div>
