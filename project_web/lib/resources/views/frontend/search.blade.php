...
<div id="wrap-inner">
	<div class="products">
		<h3 style="text-transform:none; color:#054a6a;font-size: 30px;font-family: 'Archivo Narrow', sans-serif;margin-top: 60px;margin-bottom: 20px;">Tìm kiếm với từ khóa: <span>{{$keyword}}</span></h3>
